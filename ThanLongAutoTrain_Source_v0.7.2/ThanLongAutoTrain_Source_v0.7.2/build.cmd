...
del /q dist\app.res dist\ThanLongAutoTrain_v0.7.2.exe >nul 2>nul
pushd resources
...
zig c++ -target x86_64-windows-gnu -O2 -std=c++17 -Wall -Wextra -Werror -municode -static -s ^
  ...
  -o dist\ThanLongAutoTrain_v0.7.2.exe
if errorlevel 1 exit /b 1
echo BUILD THANH CONG: dist\ThanLongAutoTrain_v0.7.2.exe
